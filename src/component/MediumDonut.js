...
function MediumDonut(positionTop, positionLeft) {
	...
	clearInterval(id1);
	id1 = setInterval(donutMove(el, 600 + positionTop, 1000 + positionLeft, Math.floor(Math.random() * 650), Math.floor(Math.random() * 1200)), 10);
